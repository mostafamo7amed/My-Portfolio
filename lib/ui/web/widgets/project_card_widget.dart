    ...
    return Container(
      decoration: BoxDecoration(
        ...
        gradient: LinearGradient(
          colors: [
            isEvenIndex ? AppColors.darkGray100 : AppColors.darkGray50,
            isEvenIndex ? AppColors.darkGray50 : AppColors.darkGray100,
          ],
          stops: const [0.5, 0.5],
                  ...
                  verticalSpace(15),
                    Row(
                      children: [
                        ...
                        if (project.demoLink!= '')
                        IconButton(
                          onPressed: () => launchUrlFunction(project.demoLink),
